...
После того как мы восстановили наш файл json надо отправить proof командой которую мы получили на сайте https://fun.soundness.xyz/ ""🔧 Ready-to-Submit to Soundness Layer Command" и в этой команде подставить имя которое мы указывали ```<key-name>```
